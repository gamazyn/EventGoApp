...
namespace EventGo.Persistence.Migrations
{
    ...
    [Migration("20220725200038_UpdateIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventGo.Domain.Identity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EventGo.Domain.Identity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EventGo.Domain.Identity.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EventGo.Domain.Evento", b =>
                {
                    b.HasOne("EventGo.Domain.Identity.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("EventGo.Domain.Identity.UserRole", b =>
                {
                    b.HasOne("EventGo.Domain.Identity.Role", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("EventGo.Domain.Identity.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("EventGo.Domain.Identity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
